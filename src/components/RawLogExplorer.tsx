                ...
                <Table.Tr key={log.id}>
                  ...
                  <Table.Td>
                    <Stack gap={2}>
                      <Group justify="space-between">
                        ...
                        <Text
                          size="xs"
                          fw={log.sentBytes > 1000000 ? 700 : 400}
                          c={log.sentBytes > 1000000 ? "orange" : undefined}
                        >
                  ...
                  <Table.Td>
                    <Stack gap={4} align="flex-start">
                      <Badge
                        color={log.action === "Blocked" ? "red" : "gray"}
                        variant="light"
                        size="xs"
                      >
                        {log.action || "Unknown"}
                      ...
                      <Badge
                        color={
                          log.responseCode?.startsWith("4") ||
                          log.responseCode?.startsWith("5")
                            ? "red"
                            : "green"
                        }
                        variant="dot"
                ...
                <Table.Td colSpan={9}>
                  <Center py="xl">
                    <Text c="dimmed">
                      {isFetching
                        ? "Loading logs..."
                        : "No ZScaler logs found for this search query."}
                    </Text>
                  </Center>
                </Table.Td>
              </Table.Tr>
    ...
    >
      ...
      {totalPages > 0 && (
        <Group
          justify="center"
          p="md"
          style={{ borderTop: "1px solid var(--mantine-color-border)" }}
        >
          <Pagination
            total={totalPages}
            value={page}
